...
from configgen.retrobox_paths import EMULATORS, RESOURCES_DIR, SAVES, mkdir_if_not_exists
        ...
        if dir.exists():
            ...
            if system.name == 'atomiswave':
                ...
                if emulator == 'play':
                    ...
                    dst = EMULATORS / 'play' / 'Play Data Files' / 'arcadesaves' / f'{rom.stem}.backupram'
                    _copy_file(src, dst)
