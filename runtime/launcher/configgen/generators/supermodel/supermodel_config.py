...
from .supermodel_paths import _SUPERMODEL_CFG

SUPERMODEL_CFG_TEMPLATE = """
;;
...
InputKick2 = "JOY2_BUTTON1"
InputGuard2 = "JOY2_BUTTON4"
...
InputAnalogJoyEvent = "JOY1_BUTTON1,MOUSE_RIGHT_BUTTON"
...
InputOffscreen = "JOY1_BUTTON1,MOUSE_RIGHT_BUTTON"    ; point off-screen
...
InputTrigger2 = "JOY2_ZAXIS_NEG,JOY2_BUTTON3"
...
InputAnalogTriggerRight = "JOY1_BUTTON1,MOUSE_RIGHT_BUTTON"    ;Lost World off-screen
...
InputAnalogTriggerLeft2 = "JOY2_ZAXIS_NEG,JOY2_BUTTON3"    ;Lost World trigger
InputAnalogTriggerRight2 = "JOY2_BUTTON1"    ;Lost World off-screen
...
def configPadsIni(system: Emulator, rom: Path, guns: Guns) -> None:
    ...
    template_config.read_string(SUPERMODEL_CFG_TEMPLATE)
            ...
            for key, _ in target_config.items(section):
                if key == "InputSystem":
                    if system.config.use_guns and guns:
                        target_config.set(section, key, "evdev")
                    else:
                        target_config.set(section, key, "sdlgamepad")
                    ...
                    if key == "InputAnalogJoyX":
                        ...
                        target_config.set(section, key, "MOUSE1_BUTTONX1,JOY1_BUTTON8")
                    elif key == "InputCoin1":
                        target_config.set(section, key, "MOUSE1_BUTTONX2,JOY1_BUTTON7")
                    ...
                    # Player 2 gun bindings
                        ...
                        if key == "InputAnalogJoyX2":
                            ...
                            target_config.set(section, key, "MOUSE2_BUTTONX1,JOY2_BUTTON8")
                        elif key == "InputCoin2":
                            target_config.set(section, key, "MOUSE2_BUTTONX2,JOY2_BUTTON7")
                        elif key == "InputAnalogJoyEvent2":
                            target_config.set(section, key, "MOUSE2_MIDDLE_BUTTON")

    # save the ini file
    with ensure_parents_and_open(_SUPERMODEL_CFG, 'w') as configfile:
