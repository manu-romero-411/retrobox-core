...
from .dosbox_x_paths import _DOSBOX_X_CFG, _DOSBOX_X_EMUDIR, _DOSBOX_X_XDG
from ... import Command
...
class DosBoxxGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        customConfFile = _DOSBOX_X_EMUDIR / 'dosboxx-custom.conf'
        ...
        return Command.Command(array=commandArray, env={"XDG_CONFIG_HOME": _DOSBOX_X_XDG})
