...
_PLAY2_EMUDIR: Final = EMULATORS / 'play'
_PLAY2_XDG: Final = _PLAY2_EMUDIR / 'configs'
_PLAY2_CFGDIR: Final = _PLAY2_XDG / 'play'
_PLAY2_SAVES: Final = SAVES / 'play2'
PLAY2_CFG: Final = _PLAY2_CFGDIR / 'Play Data Files' / 'config.xml'
PLAY2_INPUT_FILE: Final = _PLAY2_CFGDIR / 'Play Data Files' / 'inputprofiles' / 'default.xml'
...
class PlayGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        mkdir_if_not_exists(_PLAY2_CFGDIR)
        mkdir_if_not_exists(_PLAY2_SAVES)
        ...
        preferences = {
            'ps2.arcaderoms.directory': {'Type': 'path', 'Value': f'{ROMS}/namco2x6'},
        ...
        PLAY2_CFG.parent.mkdir(parents=True, exist_ok=True)
        tree.write(PLAY2_CFG)
        ...
        PLAY2_INPUT_FILE.parent.mkdir(parents=True, exist_ok=True)
        input_tree.write(PLAY2_INPUT_FILE)
        ...
        return Command.Command(
            array=commandArray,
            env={
                "XDG_CONFIG_HOME": _PLAY2_CFGDIR,
                "XDG_DATA_HOME": _PLAY2_CFGDIR,
