...
TMP_DIR="$(mktemp -d)"
TARBALL_URL="https://store.batocera.org/music-pack-vol-2-1.0.0-1-any.pkg.tar.zst"
PACK_NAME="music-pack-2"
...
function install() {
    ...
    # Single download, single decompression. Everything else reads from local files.
